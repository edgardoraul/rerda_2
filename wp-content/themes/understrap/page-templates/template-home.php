    ...
    <div class="container">
        <div class="row pb-4">
            <div class="col col-12 col-md-11">
                <h2><?php echo $redes["titulo"]; ?></h2>
                <p><?php echo $redes["bajada"]; ?></p>
            </div>
            <div class="col col-12 col-md-1">
                <div class="rrss-icons">
                    <a target="_blank" href="<?php the_field('facebook', 'option'); ?>" target="_blank"><?php $path = get_template_directory_uri().'/images/facebook.svg'; echo file_get_contents($path); ?></a>
                    <a target="_blank" href="<?php the_field('instagram', 'option'); ?>" target="_blank"><?php $path = get_template_directory_uri().'/images/instagram.svg'; echo file_get_contents($path); ?></a>
                </div>
            </div>
        </div>
        <div class="row d-none d-md-block">
            ...
            <?php if($redes["feed_shortcode"]): ?>
                <?php echo $redes["feed_shortcode"]; ?>
            <?php else: ?>   
